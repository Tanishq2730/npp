...
const philosophyData = [
  {
    ...
    imageSrc: "/static/images/philosophy/ph1.png",
    fullDescription:
      "This heading captures the essence of providing education, employment, and empowerment for all sections of society.",
  },
  {
    ...
    imageSrc: "/static/images/philosophy/ph2.png",
    fullDescription:
      "This heading captures the essence of providing education, employment, and empowerment for all sections of society.",
  },
  {
    ...
    imageSrc: "/static/images/philosophy/ph3.png",
    fullDescription:
      "This heading captures the essence of providing education, employment, and empowerment for all sections of society.",
  },
  {
    ...
    description:
      "This heading combines the ideas of maintaining India unity and promoting nationalism, highlighting the importance of a strong and unified nation.",
    imageSrc: "/static/images/philosophy/ph4.png",
    fullDescription:
      "This heading captures the essence of providing education, employment, and empowerment for all sections of society.",
  },
];
...
const Philosophy: React.FC = () => {
  ...
  return (
    <div className="bg-[#f3f1e9] pb-2 md:container-fluid md:mx-auto">
